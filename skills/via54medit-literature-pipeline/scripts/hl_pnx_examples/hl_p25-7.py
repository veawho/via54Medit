...
SRC = os.path.join(project_paths.TMA_ROOT, "step3_pdf下载_106目录/P25-7_main.pdf")
OUT = os.path.join(project_paths.TMA_ROOT, "step4_highlight_106目录_合并DOI/P25-7/P25-7_highlight.pdf")
