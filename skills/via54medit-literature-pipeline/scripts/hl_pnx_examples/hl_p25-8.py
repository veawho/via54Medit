...
SRC = os.path.join(project_paths.TMA_ROOT, "step3_pdf下载_106目录/P25-8_main.pdf")
OUT = os.path.join(project_paths.TMA_ROOT, "step4_highlight_106目录_合并DOI/P25-8/P25-8_highlight.pdf")
