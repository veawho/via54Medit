...
PDF = os.path.join(project_paths.TMA_ROOT, "step3_pdf下载_106目录/P23-7_main.pdf")
OUT = os.path.join(project_paths.TMA_ROOT, "step4_highlight_106目录_合并DOI/P23-7/P23-7_highlight.pdf")
