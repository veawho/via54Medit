...
SRC = os.path.join(project_paths.TMA_ROOT, "step3_pdf下载_106目录/P30-2_main.pdf")
OUT = os.path.join(project_paths.TMA_ROOT, "step4_highlight_106目录_合并DOI/P30-2/P30-2_highlight.pdf")
