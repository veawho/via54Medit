...
SRC = os.path.join(project_paths.TMA_ROOT, "step3_pdf下载_106目录/P31-4_main.pdf")
OUT = os.path.join(project_paths.TMA_ROOT, "step4_highlight_106目录_合并DOI/P31-4/P31-4_highlight.pdf")
