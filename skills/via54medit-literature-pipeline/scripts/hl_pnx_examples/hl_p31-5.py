...
SRC = os.path.expanduser("~/Desktop/TMA_文献整理/step3_pdf下载_106目录/P31-5_main.pdf")
OUT = os.path.expanduser("~/Desktop/TMA_文献整理/step4_highlight_106目录_合并DOI/P31-5/P31-5_highlight.pdf")
