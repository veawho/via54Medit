...
PDF = os.path.join(project_paths.TMA_ROOT, "step3_pdf下载_106目录/P9-2_main.pdf")
OUT = os.path.join(project_paths.TMA_ROOT, "step4_highlight_106目录_合并DOI/P9-2/P9-2_highlight.pdf")
