...
PDF = os.path.join(project_paths.TMA_ROOT, "step3_pdf下载_106目录/P14-3_main.pdf")
OUT = os.path.join(project_paths.TMA_ROOT, "step4_highlight_106目录_合并DOI/P14-3/P14-3_highlight.pdf")
