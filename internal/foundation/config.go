	...
	return &Config{
		...
		Sections: map[string]map[string]any{
			"sources": {
				...
				"antfu":    map[string]any{"enabled": true, "cdp_url": "http://localhost:9223", "deep_search": true, "timeout": "60s"},
			},
			...
			"llm":         {"default": "hermes", "hermes": map[string]any{"endpoint": "http://localhost:8642", "model": "MiniMax-M3"}},
