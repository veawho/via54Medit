...
SRC = os.path.join(project_paths.TMA_ROOT, "step3_pdf下载_106目录/P27-1_main.pdf")
OUT = os.path.join(project_paths.TMA_ROOT, "step4_highlight_106目录_合并DOI/P27-1/P27-1_highlight.pdf")
