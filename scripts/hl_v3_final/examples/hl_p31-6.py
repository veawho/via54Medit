...
SRC = os.path.expanduser("~/Desktop/TMA_文献整理/step3_pdf下载_106目录/P31-6_main.pdf")
OUT = os.path.expanduser("~/Desktop/TMA_文献整理/step4_highlight_106目录_合并DOI/P31-6/P31-6_highlight.pdf")
