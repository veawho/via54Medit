...
SRC = os.path.join(project_paths.TMA_ROOT, "step3_pdf下载_106目录/P31-6_main.pdf")
OUT = os.path.join(project_paths.TMA_ROOT, "step4_highlight_106目录_合并DOI/P31-6/P31-6_highlight.pdf")
