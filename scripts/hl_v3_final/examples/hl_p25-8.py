...
SRC = os.path.expanduser("~/Desktop/TMA_文献整理/step3_pdf下载_106目录/P25-8_main.pdf")
OUT = os.path.expanduser("~/Desktop/TMA_文献整理/step4_highlight_106目录_合并DOI/P25-8/P25-8_highlight.pdf")
