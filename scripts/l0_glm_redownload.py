...
PROJECTS = {
    "TMA": {
        "rerun_csv": os.path.join(project_paths.TMA_ROOT, "_3_highlight_v10_glm/_rerun_summary.csv"),
        "source_csv": os.path.join(project_paths.TMA_ROOT, "_citation_table/tma_citation_table.csv"),
        "pdf_dir": os.path.join(project_paths.TMA_ROOT, "_2_pdfs"),
        "highlight_dir": os.path.join(project_paths.TMA_ROOT, "_3_highlight_v10_glm"),
    },
    "雷管方案": {
        "rerun_csv": os.path.join(project_paths.LEIGUAN_ROOT, "step4_highlight_v10_glm/_rerun_summary.csv"),
        "source_csv": os.path.join(project_paths.LEIGUAN_ROOT, "step2_标注分析/PPT_citations_8col_aligned.csv"),
        "pdf_dir": os.path.join(project_paths.LEIGUAN_ROOT, "step3_pdf下载_160目录"),
        "highlight_dir": os.path.join(project_paths.LEIGUAN_ROOT, "step4_highlight_v10_glm"),
    },
}
