...
def main():
    ...
    parser.add_argument('--out-dir', default=os.path.join(project_paths.TMA_ROOT, "_3_highlight_semantic_m3"))
    ...
    plans = json.load(open(os.path.join(project_paths.TMA_ROOT, "_3_highlight_vision/_highlight_plans.json")))
